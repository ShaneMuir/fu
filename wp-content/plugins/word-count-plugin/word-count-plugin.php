 ...
 *  Description: Adds statical information to your posts, word count and estimated reading time.
 *  Version: 1.0.0
...
class WordCountAndTimePlugin {
    ...
    function adminPage() {
        add_options_page('Word Count Settings', 'Word Count',
        'manage_options', 'word-count-settings-page', array($this, 'ourHTML'));
    }
